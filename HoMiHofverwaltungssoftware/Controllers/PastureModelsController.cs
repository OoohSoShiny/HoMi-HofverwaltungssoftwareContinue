...
namespace HoMiHofverwaltungssoftware.Controllers
{
    ...
    [ApiController]
    public class PastureModelsController : ControllerBase
    {
        private readonly HoMiHofverwaltungssoftwareContext _context;

        public PastureModelsController(HoMiHofverwaltungssoftwareContext context)
        {
            _context = context;
        }

        // GET: api/PastureModels
        [HttpGet]
